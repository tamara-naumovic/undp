...
<body>
  ...
  <button id="prikazObrisiStdd">Obrisi Studenta</button> -->
    ...
    <form method="post" name="dodajStudenta">
      ...
      <input type="submit" value="Obrisi" name="obrisi" id="btnObrisi">
    </form>
  </div>
  ...
  <div id="Predmeti" class="tabcontent">
    ...
    <form action="" method="POST" name='dodajPredmet'>
      <input type="text" name="naziv" id="predmet_ime" placeholder="naziv">
      <input type="text" name="sifra" id="predmet_sifra" placeholder="sifra">
      <input type="submit" value="Dodaj" name="dodajPredmet" id="btnDodaj">
      <input type="submit" value="Obrisi" name="obrisiPredmet" id="btnObrisi">
    </form>
  </div>
